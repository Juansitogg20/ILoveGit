...
let teddyLaUltimaLuz = new peliculas("Teddy: La ultima luz", 1, "Fantasía oscura, romance progresivo, terror psicológico, drama, aventura sobrenatural.", "Una chica, su perro y un joven desconocido enfrentan el inicio de un apocalipsis sobrenatural que desata sus miedos más profundos. Entre sombras, secretos y lazos que se fortalecen, descubren que el amor puede ser la última luz.", "../IMG/Teddy la ultima luz.webp", "../IMG/teddy la ultima luz portada.webp", "Kagayaki no Fin — El Brillo Final", "../AUDIO/Kagayaki no Fin — El Brillo Final.ogg", 5)
